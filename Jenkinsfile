                ...
                script {
                    withCredentials([usernamePassword(credentialsId: 'gitlab', usernameVariable: 'DOCKER_USERNAME', passwordVariable: 'DOCKER_PASSWORD')]) {
                        sh """
                            ...
                            docker image tag linuxappvm.eastus.cloudapp.azure.com:5050/root/e-comm-app/frontend:${env.BUILD_NUMBER} linuxappvm.eastus.cloudapp.azure.com:5050/root/e-comm-app/frontend:latest
                            docker image tag linuxappvm.eastus.cloudapp.azure.com:5050/root/e-comm-app/backend:${env.BUILD_NUMBER} linuxappvm.eastus.cloudapp.azure.com:5050/root/e-comm-app/backend:latest
